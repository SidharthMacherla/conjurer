...
#' @description This is a function that helps in sending i.e. POST the details of the requested data from uncovr API end point and sources its response. This function needs to be used along with other function such as \code{\link{extractDf}} so as to extract relevant portions of the response.
...
#' @export
buildModelData <- function(numOfObs, numOfVars, key)
{
